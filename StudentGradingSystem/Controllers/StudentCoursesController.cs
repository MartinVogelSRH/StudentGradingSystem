...
namespace StudentGradingSystem.Controllers
{
    public class StudentCoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentCourseID,UserNameStudent,SelfEvaluationID,AnswerID,GroupGradeOK,SelfEvaluationGrade,ProfessorGuessGrade,Grade")] StudentCourse studentCourse)
        {
